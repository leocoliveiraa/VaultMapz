...
const ErrorAlert = styled.div<{ $theme: "light" | "dark" }>`
  ...
  border: 1px solid
    ${(props) =>
      props.$theme === "light" ? "#fca5a5" : "rgba(239, 68, 68, 0.2)"};
...
const ChartSection = styled.div<{ $theme: "light" | "dark" }>`
  ...
  border: 1px solid ${(props) => colors[props.$theme].border};
  margin-bottom: 2rem;
  box-shadow: ${(props) => colors[props.$theme].shadow};
      ...
      <Content>
        <Header $theme={theme}>
          ...
          <Subtitle $theme={theme}>
            Controle suas finanças de forma inteligente e organize seu futuro
            financeiro
          </Subtitle>
        </Header>
